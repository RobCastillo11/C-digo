...
<head>
    ...
    <style>
        ...
        .form-group label {
            color: #4CAF50;
            /* Cambia el color de las etiquetas de los campos a un tono de verde elegante */
        }
        ...
        .custom-button {
            ...
            /* Color de texto */
            padding: 10px 20px;
            /* Espaciado interior (arriba/abajo izquierda/derecha) */
            border: none;
            /* Borde */
            border-radius: 4px;
            /* Borde redondeado */
...
<body>
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="terminacionEstudio" name="TDE" required value="<?php echo $rowEstudio['TDE']; ?>">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tipoGrupo" name="TIPO_DE_GRUPO" required value="<?php echo $rowEstudio['TdG']; ?>">
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tiempoServicio" name="TIEMPO_DE_SERVICIO" required value="<?php echo $rowEstudio['TDS']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="calificacionArmamento" name="CALIFICACION_ARMAMENTO" required value="<?php echo $rowEstudio['CDAPT']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="calificacionPunteria" name="CALIFICACION_PUNTERIA" required value="<?php echo $rowEstudio['CPAF']; ?>">
                            </div>
                            <!-- Campo de texto para Tallas y Domicilios Encuesta 2011 -->
                            <div class="form-group">
                                <label for="tallasDomicilios">Tallas y Domicilios Encuesta 2011:</label>
                                <input type="text" id="tallasDomicilios" name="TALLAS_Y_DOMICILIOS" required value="<?php echo $rowEstudio['TallasDomicilios']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nivelCalificacion" name="NIVEL_DE_CALIFICACION" required value="<?php echo $rowEstudio['NDC']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="egresadoAcademia" name="EGRESADO_DE_LA_ACADEMIA" required value="<?php echo $rowEstudio['EDLC']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="personalEgresadoAcademia" name="PERSONAL_EGRESADO_ACADEMIA" required value="<?php echo $rowEstudio['PEAG']; ?>">
                            </div>
                            <!-- Campo de texto para Curso Perito Calif -->
                            <div class="form-group">
                                <label for="cursoPeritoCalif">Curso Perito Calif:</label>
                                <input type="text" id="cursoPeritoCalif" name="CURSO_PERITO_CALIF" required value="<?php echo $rowEstudio['CPC']; ?>">
                            </div>
                        </div>
                    </div>
        ...
        ?>
        <!-- Botón "Cerrar" -->
        <a href="pag1.php" class="btn btn-primary">Atras</a>
    </div>
