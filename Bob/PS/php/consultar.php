...
<body>
    ...
    <p>NO_EMPLEADO: <span id="mostrarNoEmpleado"><?php echo $row['NO_EMPLEADO']; ?></span></p>
    <p>NOMBRE: <span id="mostrarNombre"><?php echo $row['NOMBRE']; ?></span></p>
    <p>AP: <span id="mostrarAP"><?php echo $row['AP']; ?></span></p>
    <p>FN: <span id="mostrarFN"><?php echo $row['FN']; ?></span></p>
