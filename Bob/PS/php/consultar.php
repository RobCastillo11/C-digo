    ...
    <form action="generar_pdf.php" method="POST">
        <div class="container">
            ...
            <form action="gerar.php" method="POST">
                ...
                <input type="checkbox" name="formularios[]" value="movimiento_por_cambio_asdc">
                ...
                <input type="hidden" name="NO_EMPLEADO" value="NO_EMPLEADO">
                
                <label for="todo">Todo</label>
                <input type="checkbox" id="checkAll" name="checkAll" value="todo">
        ...
        <script>
            ...
            const checkboxes = document.querySelectorAll("input[type='checkbox'][name='formularios[]']");
            ...
            checkboxes.forEach(function (checkbox) {
                checkbox.addEventListener("change", function () {
                    // Si alguna casilla de verificación se desmarca, desmarca la casilla "Todo"
                    if (!this.checked) {
